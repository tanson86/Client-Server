...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.findDigits = function () {
        var _this = this;
        this.cs.findRandomdigits().subscribe(function (client) {
            _this.client = client;
            _this.num = _this.client.digits.join('         ');
            console.log('this.client ' + JSON.stringify(_this.client));
        }, function (error) { return _this.errorMessage = error; });
    };
    AppComponent.prototype.sendSum = function () {
        var _this = this;
        this.cs.sendSum(this.client).subscribe(function (client) {
            _this.client = client;
            ...
            //this.client = client;
            _this.errorMessage = null;
            console.log('this.error ' + JSON.stringify(_this.client));
            if (!_this.client.success) {
                _this.errorMessage = 'The sum is not correct!!! Please try again';
            }
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__client_service__ = __webpack_require__("./src/app/client.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_5__client_service__["a" /* ClientService */]],
...
var ClientService = /** @class */ (function () {
    ...
    ClientService.prototype.findRandomdigits = function () {
        return this.http.get('/findDigitsToSum');
    };
    ClientService.prototype.sendSum = function (client) {
        return this.http.post('/verifySum', client);
    };
